function [codes] = jt_make_mmls_shift_code(m,fbtp,border)
%[codes] = jt_make_mmls_shift_code(m,fbtp,border)
%Generates shifted modulated Maximum Length Sequences.
% 
% INPUT
